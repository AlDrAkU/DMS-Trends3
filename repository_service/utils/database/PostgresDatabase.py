...
class PostgreSQLFileStorageRepository(FileStorageRepository):
    def __init__(self, postgres_user: str ="postgres", postgres_password: str = "postgres", postgres_host: str = "postgres", # if you are using docker-compose, use the service name else use localhost
